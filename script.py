...
class ComplianceEmailSystem:
    ...
    def get_overdue_tasks(self, days_overdue: int = 15) -> pd.DataFrame:
        ...
        overdue_tasks = self.data[
            (self.data['Status'].str.lower() == 'pending') &
            (self.data['Due Date'] < today)
        ].copy()
        
        # Calculate days overdue
        overdue_tasks['Days Overdue'] = (today - overdue_tasks['Due Date']).dt.days
    ...
    def get_department_head_email(self, domain: str) -> str:
        ...
        if domain_lower in self.department_heads:
            return self.department_heads[domain_lower]
        
        # Try partial matching for domains like "sap", "salesflo", etc.
        for dept_domain, email in self.department_heads.items():
            if dept_domain in domain_lower or domain_lower in dept_domain:
                return email
    ...
    def create_escalation_email_content(self, department_tasks: pd.DataFrame, department_head: str, domain: str) -> str:
        ...
        <body>
            <div class="header">
                <h2>🚨 URGENT: Compliance Task Escalation Report</h2>
            ...
            <div class="summary">
                <h3>📊 Overdue Tasks Requiring Immediate Attention:</h3>
            </div>
        ...
        html_content += f"""
            ...
            <div class="footer">
                ...
                <ul>
                    ...
                    <li>Review the reasons for delay and implement corrective actions</li>
    ...
    # === EXISTING METHODS (keep all your existing methods exactly as they were) ===
